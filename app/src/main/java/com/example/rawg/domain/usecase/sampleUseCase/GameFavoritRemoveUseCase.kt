 ...
 */
class GameFavoritRemoveUseCase @Inject constructor(private val repository: SampleDataSource) :
    BaseUseCase<Unit, GameFavoritRemoveUseCase.Params>() {

    class Params(val gameItem: GameItem)

    override suspend fun run(params: Params) {
       return repository.removeToFavorit(params.gameItem)
    }
